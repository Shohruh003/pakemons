...
for (item of pokemons) {
  ...
  elLink.href = '#';
	...
	elHeight.textContent = `${item.height}`;
	elWeight.textContent = `${item.weight}`;
	elType.textContent = `${item.type}`;
  elEgg.textContent = `${item.egg}`;
  elWeak.textContent = `${item.weaknesses}`;
	elImg.src = `${item.img}`;

	elLink.appendChild(elId);
	elLink.appendChild(elImg);
	elLink.appendChild(elName);
  elLink.appendChild(elType);
	elLink.appendChild(elHeight);
	elLink.appendChild(elWeight);
  elLink.appendChild(elEgg);
  elLink.appendChild(elWeak);
	
  elLink.classList.add('js-link');
  newItem.classList.add('js-list__item');
  elName.classList.add('js-name');
  elId.classList.add('js-id');
  elImg.classList.add('js-img');
  elType.classList.add('js-type');
  elHeight.classList.add('js-height');
  elWeight.classList.add('js-weight');
  elEgg.classList.add('js-egg');
  elWeak.classList.add('js-weak');
